...
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta charset="UTF-8">
    <meta name="description" content="Fepa sing up page">
    <meta name="keywords" content="HTML, CSS, JavaScript, fepa">
    <meta name="author" content="Tomescu Mircea-Andrei">
    <meta name="author" content="Burcă Flavian">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title property="name">Failed Confirmation</title>
...
<main typeof="WebPageElement">
    <div id="background">
        <div id="container" typeof="ItemList">
            <h1 property="headline" style="color: red;">Invalid or expired confirmation link!</h1>
        </div>
    </div>
</main>
